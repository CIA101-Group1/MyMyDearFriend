...
public class EmployeeBackendController {
    ...
    public ResDTO<?> employeeEdit(
        ...
        employeeService.employeeEdit(req, loginSource);
        return new ResDTO<>();
    }
    ...
    public @ResponseBody ResDTO<EmployeeDetailResDTO> employeeDetail(
        ...
        res.setData(employeeService.employeeDetail(loginSource));
        return res;
    }

    @PostMapping("employee/login")
    public @ResponseBody ResDTO<LoginResDTO> employeeLogin(@Valid @RequestBody LoginReqDTO req)
            throws IOException {
