...
public class WalletHistoryServiceImpl implements WalletHistoryService {
  ...
  public WalletWithdrawAllResDTO walletWithdrawAll(
    ...
    for (WalletRequestEntity walletRequestEntity : pageResult.getContent()) {
      WalletWithdrawCreateResDTO walletWithdrawCreateResDTO = new WalletWithdrawCreateResDTO();
      walletWithdrawCreateResDTO.setStatus(walletRequestEntity.getStatus());
      walletWithdrawCreateResDTO.setRequestDate(String.valueOf(walletRequestEntity.getRequestDate()));
      walletWithdrawCreateResDTO.setDoneDate(String.valueOf(walletRequestEntity.getDoneDate()));
