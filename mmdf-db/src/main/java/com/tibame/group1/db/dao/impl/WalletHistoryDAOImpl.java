...
public class WalletHistoryDAOImpl implements WalletHistoryDAO {
  ...
  // wallet_amount)\n"
  //            + "SELECT wh.member_id, :changeAmount, :changeType, :changeTime, m.wallet_amount\n"
  ...
  //    String sql = "SELECT wallet_amount FROM wallet_history WHERE member_id = :memberID ORDER BY
